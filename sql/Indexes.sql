...
drop index if exists idx_purchase_article_id_dataset_name;
create index idx_purchase_article_id_dataset_name on purchase(article_id, dataset_name);
drop index if exists idx_purchase_price;
create index idx_purchase_price on purchase(price);

-- Statistics
drop index if exists idx_statistics_algorithm_date;
...
create index idx_parameter on parameter("parameter_name","algorithm_id");
