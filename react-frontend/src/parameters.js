...
export const LookBackWindow = (id) => {
    return RealNumberField("LookBackWindowParameter"+ id, "Look Back X-days Window:", "Enter X");
};

export const KNearest = (id) => {
    return RealNumberField("KNearestParameter"+ id, "Look at K Nearest:", "Enter K");
};
...
export const RetrainInterval = (id) => {
    return RealNumberField("RetrainIntervalParameter"+ id, "Retrain every Y days:", "Enter Y");
};
